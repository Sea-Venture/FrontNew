...
import { becomeGuide as becomeGuideService } from "@/services/authService";
...
export default function BecomeGuideForm({ onClose }: BecomeAdminFormProps) {
    ...
    try {
      ...
      if (formData.touristLicence) {
        ...
        try {
          ...
          licenceDocumentUrl = uploadResponse.url;
      ...
      await becomeGuideService(user.id, becomeGuideData);
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-blue-200/50 p-6 sm:p-8 ghibli-card">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold ghibli-text-gradient">Become a Guide</h1>
              <p className="text-blue-600 text-sm mt-1">Apply to become a Sea Ventures guide</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <FieldGroup>
              ...
              {uploadProgress && (
                <Field>
                  <div className="text-blue-600 text-center bg-blue-50 p-3 rounded-lg border border-blue-200">
                    {uploadProgress}
                  </div>
                </Field>
              )}
              ...
              <Field className="pt-4">
                ...
                >
                  {isSubmitting ? "Submitting Application..." : "Submit Guide Application"}
                </Button>
              </Field>
            </FieldGroup>
          </form>
